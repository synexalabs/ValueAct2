...
EXTRAPOLATION_PARAMETERS = {
    "EUR": {"llp": 20, "fsp": 20, "convergence_period": 40},  # Converge at year 60
...
def calculate_present_value_eiopa(
    ...
    pv = sum(amount * discount_factors.get(maturity, 1.0) 
...
def get_curve_summary(
    ...
    """
    curve = get_eiopa_yield_curve(currency=currency, country=country, include_va=include_va)
