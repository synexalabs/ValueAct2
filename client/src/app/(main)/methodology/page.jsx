...
import { Calculator, Shield, DollarSign, ChevronDown, Binary, Zap, ArrowRight, TrendingUp } from 'lucide-react';
                    ...
                    {methodologySections.map((section) => {
                        ...
                        return (
                            <motion.div
                                ...
                                viewport={{ once: true }}
                                className={`group border border-gray-100 rounded-[2.5rem] overflow-hidden transition-all duration-500 ${isExpanded ? 'bg-white shadow-2xl shadow-gray-200/50' : 'bg-white hover:shadow-xl hover:shadow-gray-200/30'}`}
                            >
                                <button
